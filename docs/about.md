...
We run through pwn.college, TryHackMe, PortSwigger — together. Locked units, real labs, actual tests. You don't advance until you prove it. No one gets left behind, and no one skips ahead. We hold each other accountable.

## Meet

Movie nights picking apart real breaches. Hackathons where we break things and fix them. Conferences and webinars we attend as a crew. We present, we compete, we learn from each other — not from a stage, from the person sitting next to us.
...
We train communication, discipline, and confidence alongside hacking. If you want to be the kind of person companies notice before graduation, come through.

## Students who are tired of learning alone

Scattered tutorials and no accountability kill progress. Here, we move together.
