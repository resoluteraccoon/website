...
Resolute Raccoon. We took the name directly from the codename of the latest Ubuntu release. We don't know if we've infringed on their IP — we'll reach out to them about it. But we also know this: through the rigorous training and structure we're building, our members will soon be able to answer that question precisely. We use Ubuntu primarily for all our learning. We hope they become a sponsor not too far from now.
